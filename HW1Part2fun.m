function [L_m1_table,L_m2_table, L_m1_table_100, L_m2_table_100]=HW1Part2fun()
...
% title('Generatated Model 1')
% legend('Few Points','Training Data','d=1','d=3','d=5','d=9')
% 
% % Model 2
% figure()
% axis([0 1 -0.5 1.5]);
